...
export function StorefrontCatalog({ slug, products }: StorefrontCatalogProps) {
  return (
        ...
        <div className="grid gap-x-5 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
          {products.map((product) => (
            <Link
              ...
              className="group block overflow-hidden rounded-[1.5rem] border border-border/60 bg-card transition-colors hover:border-foreground/20"
            >
              <article>
                <div
