...
type ShipmentRepository interface {
	...
	UpdateStatus(ctx context.Context, id uuid.UUID, status models.ShipmentStatus) error
	AppendCarrierEvent(ctx context.Context, id uuid.UUID, event []byte) error
}
...
func (r *shipmentRepo) GetByOrderID(ctx context.Context, orderID uuid.UUID) (*models.Shipment, error) {
	s := &models.Shipment{}
...
func (r *shipmentRepo) UpdateStatus(ctx context.Context, id uuid.UUID, status models.ShipmentStatus) error {
	_, err := r.db.Exec(ctx,
...
func (r *shipmentRepo) AppendCarrierEvent(ctx context.Context, id uuid.UUID, event []byte) error {
	_, err := r.db.Exec(ctx, `
		UPDATE shipments
